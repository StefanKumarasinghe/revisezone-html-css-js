...
function Time() {
	...
	var x = setInterval(function() {
		...
		document.getElementById("displaytime").innerHTML = hours + "h " + minutes + "m " + seconds + "s ";
...
localStorage.removeItem("Updates");
	if (localStorage.getItem("NewUpdates") == null) {
		var modal = document.getElementById('id01');
	...
	if (localStorage.getItem("Notification") == "TRUE") {
	    ...
	    if (localStorage.getItem("play") != "#6") {
	    
		var modale = document.getElementById('notification');
		setTimeout(function display() {
			modale.style.display = "block";
			modale.style.opacity = "1";
			modale.style.transition = "opacity 3s";
		}, 2000)
...
function audio() {
	document.getElementById("audiobar").style.height="80px";
	document.getElementById("audiobar").style.transition="height 0.4s";
	document.getElementById('audioplay').setAttribute("onClick", "DisableAudio()");
	
}
function DisableAudio() {
	document.getElementById("audiobar").style.height="0px";
	document.getElementById("audiobar").style.transition="height 0.4s";
	document.getElementById('audioplay').setAttribute("onClick", "audio()");
	
}
function MiniTask(x,address){
...
function Minivideo(x,address){
 var para = document.createElement("iframe");
x.innerHTML="Hide?";
x.setAttribute("onClick", "RemoveFrame(this)");
 para.src=address
 para.id="videoframe"

 var element = document.getElementById("classview");
 element.appendChild(para);
}
function RemoveFrame(x){
x.setAttribute("onClick", "DisplayFrame(this)");
x.innerHTML="Show?";
document.getElementById("classview").style.display="none";


}
function DisplayFrame(x){
x.setAttribute("onClick", "RemoveFrame(this)");
x.innerHTML="Hide?";
